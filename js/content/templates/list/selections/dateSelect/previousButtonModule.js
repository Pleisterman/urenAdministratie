...
( function( mbAdminApp ){
    ...
    // get name space
    const nameSpace = mbAdminApp.content.templates.list.selections.dateSelect;
    
    // MODULE: previousButtonModule( html element id: parentId, 
    //                               named array: buttonOptions, 
    //                               named array: listOptions,
    //                               named array: callbacks ) named array
    nameSpace.previousButtonModule = function( parentId, buttonOptions, listOptions, callbacks ) {
        // PRIVATE:

        // MEMBERS:
        const self = this;                                          // object
        self.MODULE = 'ContentTemplatesListsDateSelectPreviousButtonModule';  // string
        ...
        self.hoverText = 'Previous day';                            // string
        ...
        // FUNCTION: click( event: event ) void
            ...
            // set user option
            mbAdminApp.setUserOption( self.listOptions['subject'] + 'ListSelectionOffset', self.getPreviousDay() );
        ...
        self.getPreviousDay = function( ) {
        // FUNCTION: getPreviousDay( void ) void
        ...
        // DONE FUNCTION: getPreviousDay( void ) void
        };
    ...
    // DONE MODULE: previousButtonModule( html element id: parentId, 
    //                                    named array: buttonOptions, 
    //                                    named array: listOptions,
    //                                    named array: callbacks ) named array
