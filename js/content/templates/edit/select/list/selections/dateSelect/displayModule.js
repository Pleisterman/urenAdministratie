...
( function( mbAdminApp ){
    ...
    // get name space
    let nameSpace = mbAdminApp.content.templates.edit.select.list.selections.dateSelect;
    ...
    nameSpace.displayModule = function( parentId, left, listOptions, callbacks ) {
        ...
        self.MODULE = 'ContentTemplatesEditSelectListRowSelectDateSelectDisplayModule';  // string
