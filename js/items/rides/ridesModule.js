...
( function( mbAdminApp ){
    ...
    // create name space
    nameSpace.rides = nameSpace.rides ? nameSpace.rides : {};
    
    // MODULE: ridesModule( html element id: listsContainerId ) named array  
    nameSpace.rides.ridesModule = function( listsContainerId ) {
        // PRIVATE:

        // MEMBERS:
        let self = this;                                    // object
        self.MODULE = 'ItemsRidesModule';                   // string
        self.debugOn = false;                               // boolean
        self.listsContainerId = listsContainerId;           // html element id
        self.listOptions = {                                // named array
            'subject'           :   'rides',                // string  
            'title'             :   'Rides',                // string  
        ...
        self.dataModule = nameSpace.rides.dataModule;       // module
        ...
        // FUNCTION: getEditModule( void ) module
            ...
            // return edit module
            return new nameSpace.rides.editModule();
        ...
        return {
            ...
            // FUNCTION: getDataModule( void ) module    
    ...
    // DONE MODULE: ridesModule( html element id: listsContainerId ) named array  
