...
class closedList {
    ...
    public function get( $listOptions ) {
        ...
        // debug info
        $this->debug( 'list: ' . $listOptions['subject'] . ' getClosedList offset: ' . $listOptions['offset'] );
        ...
        $options = array(
            ...
            'clauses'   => [array( 'name' => 'closed', 'value' => 'not null' )],
            'order'     => ['name ASC'],
            'limit'     => true,
            'variables' => '',
            'values'    => []
    ...
    private function getOffsetCount( $listOptions, $name ) {
        ...
        $options = array(
            ...
            'tables'    => [$listOptions['subject']],
            'columns'   => ['count(*) as count'],
            'clauses'   => ['name <=', array( 'name' => 'closed', 'value' => 'not null' )],
            'order'     => ['name ASC'],
            'variables' => 's',
            'values'    => [$name]
        );
