/*
    ...
    function:       displays the previous button the row select of the list template
...
( function( mbAdminApp ){
    ...
    // get name space
    const nameSpace = mbAdminApp.content.templates.list.selections.rowSelect;
    ...
    nameSpace.previousButtonModule = function( parentId, buttonOptions, data, listOptions, callbacks ) {
        // PRIVATE:

        // MEMBERS:
        const self = this;                                            // object
        self.MODULE = 'ContentTemplatesListRowSelectPreviousButtonModule'; // string
        ...
        self.hoverText = 'Previous';                                // string
        ...
        // FUNCTION: click( event: event ) void
            ...
            // set user option
            mbAdminApp.setUserOption( self.listOptions['subject'] + 'ListSelectionOffset', self.data['previousPageId'] );
