/*
    ...
    function:       Adds the function:
                        ...
                        mbAdminApp.debug: displays messages on screen when on. 
...
( function( mbAdminApp ){
    ...
    // MODULE: debugModule( named array / undefined: options ) named array 
    mbAdminApp.service.debugModule = function( options ) {        
        // PRIVATE:
        ...
        // FUNCTION: extendOptions( void ) void
            ...
            // set on
            self.on = options['on'] !== undefined && options['on'] ? true : false; 
    ...
    // DONE MODULE: debugModule( named array / undefined: options ) named array 
