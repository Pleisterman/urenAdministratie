/*
        ...
        function:       displays the date select of the list template
...
( function( mbAdminApp ){
    ...
    // get name space
    const nameSpace = mbAdminApp.content.templates.list.selections;
    
    // create name space
    nameSpace.dateSelect = nameSpace.dateSelect ? nameSpace.dateSelect : {};
    
    // MODULE: dateSelectModule( html element id: parentId, 
    //                           named array: listOptions,
    //                           named array: data,
    //                           named array: callbacks ) named array  
    nameSpace.dateSelect.dateSelectModule = function( parentId, listOptions, data, callbacks ) {
        // PRIVATE:

        // MEMBERS:
        const self = this;                                      // object
        self.MODULE = 'ContentTemplatesListDateSelectModule';   // string
        ...
        // FUNCTION: addButtons( void ) void
            ...
            const previousButtonModule = nameSpace.dateSelect.previousButtonModule;
        ...
        // FUNCTION: addDateDisplay( void ) void
            ...
            // debug info
            self.debug( 'addDateSelection' );

            // get display module
            const displayModule = nameSpace.dateSelect.displayModule;
        ...
        // FUNCTION: addNextButton( void ) void
            ...
            const nextButtonModule = nameSpace.dateSelect.nextButtonModule;
